...
class SpeisekarteSpider(scrapy.Spider):
    ...
    def parse_dir(self, response):
        ...
        # Only continue paging through the directory as long as we still discover new city links
        if new_count > 0:
    ...
    def parse_city(self, response):
        ...
        # Parse listing cards and schedule detail page requests (if a detail URL exists)
        for card in cards:
        ...
        # Pagination for the city restaurant list
    ...
    def parse_detail(self, response):
        ...
        # Enrich listing data with detail page fields
